...
print("You can edit me, and run the code.");</codeedit>
		...
		<codeedit editorID="start/imaprogram">print("I'm a program!");</codeedit>
		<p>
		...
		<codeedit editorID="start/programlines">print("Hello, world!");
print("It's a great day to be alive!");
print("It's a great day to learn about coding!");</codeedit>
		<p>
		...
		<codeedit editorID="start/simplemathoperators">print(3 + 5);
print(10/2);
print(5 + (3*2));
print(6/(2+1));</codeedit>
		<p>
		...
		<codeedit editorID="start/somemathfunctions">// Constants
print( e );
print( pi );
...
<script>
	...
	export default {
		...
		mounted() {
			this.$store.commit('changeTitle', 'JavaScript and Math')
			renderMath();
		}
	}
</script>